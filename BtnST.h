...
#define	BTNST_AUTO_GRAY					(HICON)(-1)
#endif
// Dummy identifier for 15% darker icon
#ifndef	BTNST_AUTO_DARKER
#define	BTNST_AUTO_DARKER				(HICON)(-2)
#endif
...
public:
	...
	static HBITMAP CreateGrayscaleBitmap(HBITMAP hBitmap, DWORD dwWidth, DWORD dwHeight, COLORREF crTrans);
   ...
   DWORD SetFlatBorderAlways(BOOL bBoarder = TRUE, BOOL bRepaint = TRUE);
...
protected:
   ...
   COLORREF	m_crColorsSystem[BTNST_MAX_COLORS];	// Colors to be used
